# LearnTV Release v0.0.17

## Installation & Upgrade 

To install or upgrade LearnTV utility scripts v0.0.17, you should run the [install](https://raw.githubusercontent.com/raviu/learntv-releases/v0.0.17/install.sh) script. To do that, you may either download and run the script manually, or use the following cURL or Wget command:

```
curl -o- https://raw.githubusercontent.com/raviu/learntv-releases/v0.0.17/install.sh | bash
```

```
wget -qO- https://raw.githubusercontent.com/raviu/learntv-releases/v0.0.17/install.sh | bash
```
