...
BASE_URL="https://raw.githubusercontent.com/raviu/learntv-releases/v0.0.7"
VERSION="v0.0.7"
...
if [ -z "$DOWNLOADER" ]; then
    ...
    if [ "$DOWNLOADER" == "curl" ]; then 
        ...
        curl -s $BASE_URL/playout/channel-starter.sh -o channel-starter.sh 
    else 
        ...
        wget -q $BASE_URL/playout/channel-starter.sh -O channel-starter.sh 
    fi 
